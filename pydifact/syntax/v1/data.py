partner_identification_codes = {
    ...
    "5": {
        "name": "INSEE - SIRET",
        "description": "French national statistics institute. SIRET means Systeme Informatique du Repertoire des entreprises et de leurs établissements.",
    },
    "8": {
        "name": "UCC Communications ID",
        "description": "Ten-digit code used to uniquely identify physical and logical locations.",
    },
    "9": {
        "name": "DUNS with 4-digit suffix",
        "description": "Partner identification code assigned by Dun & Bradstreet with the 4-digit suffix.",
    },
    "12": {
        "name": "Telephone number",
        "description": "Partner identification code corresponds to the partner's telephone number.",
    },
    "14": {
        "name": "EAN International",
        "description": "Partner identification code assigned by EAN International.",
    },
    "18": {
    ...
    "22": {
        "name": "INSEE - SIREN",
        "description": "French national statistics institute. SIREN means Systeme Informatique du Repertoire des ENtreprises.",
    },
    "30": {
        "name": "ISO 6523: Organization identification",
        "description": "Partner identification code specified in ISO 6523.",
    },
    "31": {
    ...
    "53": {
        ...
        "description": "German data center for retail trade.",
    },
    "54": {
    ...
    "55": {
        ...
        "description": "Partner identification code corresponds to the partner's bank identification code.",
    },
    "57": {
    ...
    "61": {
        ...
        "description": "Directory of standard multimodal carriers and tariff agent codes.",
    },
    "63": {
    ...
    "82": {
        ...
        "description": "Norwegian telecommunications regulatory authority.",
    },
    "84": {
    ...
    "90": {
        "name": "SITA",
        "description": "Societe Internationale de Telecommunications Aeronautiques.",
    },
    "91": {
    ...
    "103": {
        "name": "TW, Trade-van",
        "description": "Trade-van is an EDI VAN service center for customs, transport, and insurance in trade.",
    },
    "128": {
        "name": "CH, BCNR",
        "description": "Code for the identification of a Swiss clearing bank.",
    },
    "129": {
        "name": "CH, BPI",
        "description": "Code for the identification of a corporate or a Swiss non-clearing bank.",
    },
    "144": {
        "name": "US, DoDAAC",
        "description": "Code assigned to uniquely identify all military units in the US Department of Defense.",
    },
    "145": {
        "name": "FR, DGCP",
    ...
    "147": {
        "name": "JP, JIPDEC/ECPC",
        "description": "Partner identification code registered with JIPDEC/ECPC.",
    },
    "148": {
        "name": "ITU DNIC",
        "description": "Data network identification code assigned by the ITU.",
    },
    "Z01": {
        "name": "Vehicle registration number",
        "description": "Registration number of a vehicle assigned by a recognized authority.",
    },
    "ZZZ": {
