...
from pydifact.constants import EDI_DEFAULT_VERSION, M, EDI_DEFAULT_DIRECTORY
from pydifact.exceptions import ValidationError
from pydifact.syntax.registry import SyntaxRegistry
from pydifact.utils import is_edifact_alphanum
...
# helper for declaring schema in autogenerated Segment classes:
