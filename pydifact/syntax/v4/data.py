...
partner_identification_codes = {
    "1": {
        ...
        "description": "Partner identification code assigned by Dun and Bradstreet.",
    },
    "4": {
    ...
    "8": {
        ...
        "description": "The Uniform Code Council Communications Identifier is a 10 digit code used to uniquely identify physical and logical locations.",
    },
    "9": {
        "name": "DUNS (Data Universal Numbering System) with 4 digit suffix",
        "description": "Partner identification code assigned by Dun and Bradstreet with the 4 digit suffix.",
    },
    "12": {
    ...
    "14": {
        "name": "GS1",
        "description": "Partner identification code assigned by GS1, an international organization of GS1 Member Organizations that manages the GS1 System.",
    },
    "18": {
    ...
    "30": {
        "name": "ISO/IEC 6523: Organization identification",
        "description": "Partner identification code specified in ISO/IEC 6523 (Structures for the identification of organizations).",
    },
    "31": {
    ...
    "33": {
        "name": "BfA (Bundesversicherungsanstalt für Angestellte)",
    ...
    "144": {
        "name": "US, DoDAAC (Department of Defence Activity Address Code)",
        "description": "Code assigned to uniquely identify all military units in the United States Department of Defence.",
    },
    "145": {
    ...
    "147": {
        "name": "JP, JIPDEC/ECPC (Japan Information Processing Development Corporation / Electronic Commerce Promotion Center)",
        "description": "Partner identification code which is registered with JIPDEC/ECPC.",
    },
    "148": {
        "name": "ITU (International Telecommunications Union) Data Network Identification Code (DNIC)",
