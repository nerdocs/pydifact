...
class ParserTest(unittest.TestCase):
    def setUp(self):
        self.parser = Parser()
        self.default_una_segment = Segment("UNA", list(":+,? '"))
    ...
    def test_basic1(self):
        ...
        self._assert_segments("RFF+PD:50515", [Segment("RFF", ["PD", "50515"])])
    ...
    def test_escape_decimal_point(self):
        ...
        self._assert_segments("QTY+136:12,235", [Segment("QTY", ["136", "12,235"])])

    def test_escape_segment_terminator(self):

        self._assert_segments("ERC+10:Craig?'s", [Segment("ERC", ["10", "Craig's"])])
