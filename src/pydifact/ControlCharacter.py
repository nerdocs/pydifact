...
class ControlCharacterMixin:
    ...
    def __init__(self):
        #string $componentSeparator The control character used to separate components.
        self.componentSeparator = ":"
        # string $dataSeparator The control character used to separate data elements.
        self.dataSeparator = "+"
        # string $decimalPoint The control character used as a decimal point.
        self.decimalPoint = ","
        # string $escapeCharacter The control character used as an escape character.
        self.escapeCharacter = "?"
        # string $segmentTerminator The control character used as an segment terminator.
        self.segmentTerminator = "'"

    def setControlCharacter(self, cc_type, char):
        """
        Set a control character.
        :param string $type The type of control character to set, as attribute string:
            componentSeparator, dataSeparator, decimalPoint, escapeCharacter, segmentTerminator
    ...
    def setDataSeparator(self, char):
        """
    ...
    def setEscapeCharacter(self, char):
        """
    ...
    def setSegmentTerminator(self, char):
        """
